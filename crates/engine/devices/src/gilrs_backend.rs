...
//!
//! This module provides a controller backend using the gilrs crate
//! for native gamepad support on desktop platforms.
...
/// Gilrs-based controller backend for desktop platforms
...
impl GilrsBackend {
    ...
    ///
    /// Returns an error if gilrs fails to initialize (e.g., no gamepad
    /// support available on the system).
