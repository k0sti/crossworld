        ...
        Cube::Solid(_) | Cube::Planes { .. } | Cube::Slices { .. } => {
            ...
            if should_subdivide {
                ...
                for octant_idx in 0..8 {
                    ...
                    let grid_y = (octant_pos.y + 3) / 2;
                    let grid_z = (octant_pos.z + 3) / 2;
                    let child_grid_idx = (grid_x + grid_y * 4 + grid_z * 16) as usize;
