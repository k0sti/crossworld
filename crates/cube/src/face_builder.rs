...
use crate::neighbor_traversal::{traverse_with_neighbors, NeighborGrid, OFFSET_LEFT, OFFSET_RIGHT, OFFSET_DOWN, OFFSET_UP, OFFSET_BACK, OFFSET_FRONT};
    ...
    F: Fn(i32) -> [f32; 3] + Copy,
{
    ...
    tracing::debug!("[generate_face_mesh] Generated {} faces at max_depth={}", face_count, max_depth);
}
