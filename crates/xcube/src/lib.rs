...
pub use convert::{normals_to_materials, voxelize, xcube_to_cube, ColorMode, VoxelizeConfig};
...
pub mod prelude {
    ...
    pub use crate::convert::{
        normals_to_materials, voxelize, xcube_to_csm, xcube_to_cube, ColorMode, VoxelizeConfig,
    };
