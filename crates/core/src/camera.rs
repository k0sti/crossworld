...
///
/// ```
/// use core::camera::{Camera, DEFAULT_VFOV};
/// use glam::Vec3;
///
...
/// # Example
/// ```ignore
/// use core::camera::{Camera, OrbitController, OrbitControllerConfig};
/// use glam::Vec3;
///
...
/// # Example
/// ```ignore
/// use core::camera::{Camera, FirstPersonController, FirstPersonControllerConfig};
/// use glam::Vec3;
///
