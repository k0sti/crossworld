...
///
/// ```
/// use system::camera::{Camera, DEFAULT_VFOV};
/// use glam::Vec3;
///
...
impl Camera {
    ...
    pub fn projection_matrix(&self, aspect_ratio: f32, near: f32, far: f32) -> Mat4 {
        Mat4::perspective_rh_gl(self.vfov, aspect_ratio, near, far)
    }
...
/// # Example
/// ```ignore
/// use system::camera::{Camera, OrbitController, OrbitControllerConfig};
/// use glam::Vec3;
///
...
/// # Example
/// ```ignore
/// use system::camera::{Camera, FirstPersonController, FirstPersonControllerConfig};
/// use glam::Vec3;
///
...
mod tests {
    ...
    fn test_view_matrix() {
        ...
        // Basic sanity check - matrix should be valid
    }
}
