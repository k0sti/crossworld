...
- [ ] **Investigate mesh renderer camera issue**
...
- [ ] **Investigate mesh face rendering issue**
...
- [ ] **Analyze mesh regeneration frequency**
...
- [ ] **Fix mesh renderer camera calculation**
...
- [ ] **Add camera sync validation test**
...
- [ ] **Add mesh cache state tracking**
  - Add `mesh_needs_regeneration: bool` field to `DualRendererApp`
  - Add `mesh_cached: bool` to track if mesh is currently cached
  - Initialize both fields appropriately in `new_with_sync`
...
- [ ] **Add UI controls**
  ...
  - Add button "Regenerate Mesh" to force regeneration
  - Show cache status indicator (e.g., "Mesh: Cached" or "Mesh: Regenerated")
  - Display mesh statistics (vertex count, face count, upload time)
...
- [ ] **Update rendering logic**
  ...
  - Log mesh regeneration events for debugging
